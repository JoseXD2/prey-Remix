...
idleoffsets = {'-240', '-340'} -- I recommend you have your idle offset at 0
leftoffsets = {'-246', '-335'}
downoffsets = {'-240', '-329'}
upoffsets = {'-240', '-342'}
rightoffsets = {'-234', '-335'}
...
idle_xml_name = 'starved idle'
left_xml_name = 'starved left'
down_xml_name = 'starved down'
up_xml_name = 'starved up'
right_xml_name = 'starved right'
...
function onCreate()
    makeAnimatedLuaSprite('starved-pixel','Prey/characters/starved_sheet',-600,850)
    setProperty('starved-pixel.antialiasing', true)
    addAnimationByPrefix('starved-pixel','idle','starved idle',24,true)
end

-- pretty self-explanitory
name_of_character_xml = 'starved_sheet'
name_of_character = 'starved-pixel1'
name_of_notetype = 'a'
--name_of_notetype2 = 'a' -- for multiple characters singing at the same time
